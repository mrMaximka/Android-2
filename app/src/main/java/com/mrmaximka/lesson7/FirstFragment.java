...
public class FirstFragment extends Fragment {
    ...
    private static CheckBox swWind;      // Включен ли checkBox с ветром
    private static CheckBox swWet;       // Влажностью
    private static CheckBox swPressure;  // И давлением
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (townList.isEmpty()) {
            // Закидывает города из ресурсов, только при первом создании
            townList.addAll(Arrays.asList(cities));
        }
        ...
        swWind.setChecked(true);
        swWet.setChecked(true);
        swPressure.setChecked(true);
    }
